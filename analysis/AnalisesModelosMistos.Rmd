...
library(tidyverse)
inch <- 2.54
BLUPSDisea <- readRDS(here::here("output", "BLUPsDisease.RDS"))
#pdf(file = here::here("output", "Fig4_DenplotsBLUPsCassavaFoliarDiseaseTraits.pdf"), width = 20/inch, height = 15/inch)
...
library(tidyverse)
BlupsTraits <- readRDS(here::here("output", "BlupsFenHen.rds"))
inch <- 2.54

#pdf(file = here::here("output", "Fig5_DenplotsBLUPsCassavaAgronomicTraits.pdf"), width = 20/inch, height = 15/inch)
...
```{r table7, echo = FALSE}
library(reactable)
AllBlups <- readRDS(file = here::here("output", "BLUPsDiseaseAgro.rds"))
...
AllBlups %>%
  reactable(columns = list(Anth = colDef(format = colFormat(digits = 2, locales = "en-US")),
                           ...
                           RF = colDef(format = colFormat(digits = 2, locales = "en-US")),
...
```{r}
sink(file = here::here("output", "MediasBLUPs.txt"))
colMeans(AllBlups[,-1], na.rm = T)
sink()
write.table(AllBlups, here::here("output", "BlupsHen.txt"), quote = F, sep = "\t")
```
