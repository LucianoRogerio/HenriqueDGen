...
#pdf(file = here::here("output", "Fig6_BarplotAccumulatedVariancesPCFoliarDiseases.pdf"), width = 20/inch, height = 15/inch)
...
#pdf(file = here::here("output", "Fig7_ScatterplotPC1and2CorrelationArrowsFoliarDiseaseResistancePC.pdf"),
#      width = 20/inch, height = 15/inch)
...
```{r Correlogram}
library(corrplot)
#pdf(file = here::here("output", "Correlogram.pdf"), height = 10/inch, width = 10/inch)
...
```{r Figure 3, echo = F}
#pdf(file =here::here("output", "Fig8_ScatterplotLD1and2CassavaFoliarDiseases3clusters.pdf"), width = 20/inch, height = 15/inch)
...
library(ggpubr)
inch <- 2.54
#pdf(file = here::here("output", "Fig9_BoxplotsBLUPSDAGrpCassavaFoliarDiseases.pdf"), width = 20/inch, height = 25/inch)
